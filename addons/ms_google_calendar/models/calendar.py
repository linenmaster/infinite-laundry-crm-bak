...
class Meeting(models.Model):
    ...
    new_attendee_ids = fields.One2many('calendar.event.attendee', 'event_id', string='Attendees')
    ...
    def _get_sync_domain(self):
        ...
        day_range = 2
        lower_bound = fields.Datetime.now()
    ...
    def _odoo_attendee_commands(self, google_event):
        ...
        return attendee_commands, partner_commands,attendee_list
...
class CalendarEventAttendee(models.Model):
    ...
    _description = 'Calendar Event Attendee'

    name = fields.Char(string='Attendee Name')
    email = fields.Char(string='Attendee Email')
    event_id = fields.Many2one('calendar.event', string='Event', required=True)
