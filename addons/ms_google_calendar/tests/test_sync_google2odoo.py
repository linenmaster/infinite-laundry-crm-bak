...
from odoo.addons.ms_google_calendar.tests.test_sync_common import TestSyncGoogle, patch_api
from odoo.addons.ms_google_calendar.utils.google_calendar import GoogleEvent, GoogleCalendarService
