...
class Meeting(models.Model):
    ...
    def _microsoft_to_odoo_values(self, microsoft_event, default_reminders=(), default_values=None, with_ids=False):
        ...
        commands_attendee, commands_partner,attendee_list = self._odoo_attendee_commands_m(microsoft_event)
    ...
    def _odoo_attendee_commands_m(self, microsoft_event):
        ...
        # creating names of attendees
        attendee_list = []
        check_duplicate = []
        if microsoft_attendees:
            for attendee in microsoft_attendees:
                email = attendee.get('emailAddress', {}).get('address')  # Get email from 'emailAddress' -> 'address'
                if email:
        ...
        return commands_attendee, commands_partner, attendee_list
